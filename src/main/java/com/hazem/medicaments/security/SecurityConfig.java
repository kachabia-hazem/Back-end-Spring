package com.hazem.medicaments.security;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.sessionManagement(session -> 
            ...
            .authorizeHttpRequests(requests -> requests
                // Allow access to the API endpoint without authentication
                .requestMatchers(new AntPathRequestMatcher("/medicaments/api/**")).permitAll()
